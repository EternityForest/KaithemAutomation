# Kaithem Automation Individual Contributor License Agreement

Thank you for your interest in contributing to Kaithem Automation ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by mail or electronic submission, following the instructions in CONTRIBUTING.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
Us: The Kaithem Automation Project

Harmony (HA-CLA-I-ANY) Version 1.0

# Kaithem Automation Entity Contributor License Agreement
