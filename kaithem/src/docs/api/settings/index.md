...
| [`get_suggestions`](#kaithem.api.settings.get_suggestions)(→ list[tuple[str, str]])    |                                                                     |
| [`get_system_themes`](#kaithem.api.settings.get_system_themes)(→ list[dict[str, str]]) | Get system themes with name and URL for frontend consumption.       |
...
### kaithem.api.settings.get_suggestions(key: [str](../../src/pages/index.md#kaithem.src.pages.str)) → [list](../../src/pages/index.md#kaithem.src.pages.list)[tuple[[str](../../src/pages/index.md#kaithem.src.pages.str), [str](../../src/pages/index.md#kaithem.src.pages.str)]]

### kaithem.api.settings.get_system_themes() → [list](../../src/pages/index.md#kaithem.src.pages.list)[dict[[str](../../src/pages/index.md#kaithem.src.pages.str), [str](../../src/pages/index.md#kaithem.src.pages.str)]]
