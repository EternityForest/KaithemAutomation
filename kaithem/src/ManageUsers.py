...
class ManageAuthorization():
    ...
    def deluser(self, **kwargs):
        ...
        messagebus.postMessage("/system/auth/user/deleted",
    ...
    def delgroup(self, **kwargs):
        ...
        messagebus.postMessage("/system/auth/group/deleted",
    ...
    def newusertarget(self, **kwargs):
        ...
        messagebus.postMessage(
            "/system/auth/user/added", {'user': kwargs['username'], 'addedby': pages.getAcessingUser()})
    ...
    def newgrouptarget(self, **kwargs):
        ...
        messagebus.postMessage("/system/auth/group/added",
    ...
    def updategroup(self, group, **kwargs):
        ...
        messagebus.postMessage("/system/auth/group/changed",
