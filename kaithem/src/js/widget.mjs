...
if (globalThis.kaithemapi == undefined) {
  ...
  globalThis.kaithemapilastDidSnackbarError = 0;
      ...
      serverMsgCallbacks: {
        __WIDGETERROR__: [
          function (m) {
            console.error(m);
            if (
              globalThis.kaithemapilastDidSnackbarError <
              Date.now() - 30_000
            ) {
        ...
        __SHOWSNACKBAR__: [
          function (m) {
            picodash.snackbar.createSnackbar(m[0], m[1]);
          },
        ],
      ...
      connect: function () {
        ...
        this.poll_ratelimited = function () {
          ...
          //If we are already waiting on a poll, don't re-poll.
            ...
            this.pollWaiting = setTimeout(
              this.poll_ratelimited.bind(this),
              50 - (n - this.lastSend)
            );
          }
        };
