...
$(h).attr("placeholder",a.placeholder),$(h).attr("tooltip",a.placeholder)},c.onCalculatedValueChanged=function(a,b){if("target"==a){c.value=b;var d=b;"object"==typeof d&&(d=d[0]),d!=$(h).val()&&$(h).val(d)}"placeholder"==a&&$(h).attr("placeholder",b)},c.onDispose=function(){}}}();