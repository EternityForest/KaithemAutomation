        ...
        <div>
            <div style="display:flex;flex-direction:row;">
                ...
                <div v-if="selectedCommand==0 && selectedBinding" class="inspector">
                    ...
                    Run when:
                    <combo-box v-model="selectedBinding[0]" v-bind:options="example_events" v-on:change="$emit('input',rules);"></combo-box> occurs
                        ...
                        <div v-if="(!(selectedCommand[0] in specialCommands)) && ((commands[selectedCommand[0]] ))">
                            <table>
                                <tr v-for="i in commands[selectedCommand[0]].args.keys()">
                                    ...
                                    :options="getCompletions(selectedCommand, commands[selectedCommand[0]].args[i][0])"></td>
                                </tr>
                            </table>
                            <h5>Docs</h5>
                ...
                <div style="display:flex;flex-direction:column;align-items: center; margin-left:1em;">
                    ...
                    <p class="small">Occurs</p>
                            ...
                            <button class="action" style="align-self:stretch;" v-on:click="i[1].push(['pass']);$emit('input',rules)">Add Action</button>
                            </div>
