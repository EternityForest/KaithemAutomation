...
<template>
    <section popover id="presetsDialog" ontoggle="globalThis.handleDialogState"
        ...
        <div v-if="selectingImageLabelForPreset" class="card paper flex-col" popover id="presetImageLabel"
            ...
            <button @click="selectingImageLabelForPreset = null" popovertargetaction="hide" class="w-full nogrow">
                ...
                <template v-for="ps, i of dictView(presets, [])">
                    ...
                    >
                        <div class="tool-bar">
                            ...
                            <button class="button" type="button" popovertarget="iframeDialog"
                                @click="window.setIframeDialog(getExcalidrawPresetLink(ps[0]))">
                            ...
                            <button type="button" v-on:click="copypreset(ps[0]); filterPresets = ''"><i
...
module.exports = {
    ...
    props: [
        ...
        "deletepreset", "renamepreset", "copypreset",
    ...
    methods: {
        ...
        getExcalidrawPresetLink:function (preset) {
            return '/excalidraw-plugin/edit?module=' +
                encodeURIComponent(window.boardname.split(":")[0]) +
                '&resource=' + encodeURIComponent("media/chandler/sketches/preset_" + window.boardname.split(":")[1] + "_" +
                    preset + "_" +
                    window.session_time + ".excalidraw.png") +
                "&callback=" + encodeURIComponent("/chandler/label_image_update_callback/preset/" + window.boardname + "/" + preset) +
                "&ratio_guide=16_9"
        }
    },
    "components": {
