...
NM_DEVICE_STATE_Dis_connected = 30
...
NM_ACTIVE_CONNECTION_STATE_REASON_USER_Dis_connected = 2
NM_ACTIVE_CONNECTION_STATE_REASON_DEVICE_Dis_connected = 3
...
NM_VPN_CONNECTION_STATE_Dis_connected = 7
NM_VPN_CONNECTION_STATE_REASON_UNKNOWN = 0
NM_VPN_CONNECTION_STATE_REASON_NONE = 1
NM_VPN_CONNECTION_STATE_REASON_USER_Dis_connected = 2
NM_VPN_CONNECTION_STATE_REASON_DEVICE_Dis_connected = 3
