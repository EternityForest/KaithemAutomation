...
class NVRChannel(devices.Device):
    ...
    def connect(self, config):
        ...
        self.process.addPresenceDetector((640, 480), regions)
    ...
    def presencevalue(self, v):
        ...
        # Get the one representing the overall frame
        ...
        detect_interval = 5 if v > 0.003 else 15
