...
effectTemplates_data = {
    ...
    "opusrtpsender": {
        "type": "opusrtpsender",
        "displayType": "Opus RTP Send",
        "help": "Send raw Opus audio via RTP to anyone who subscribes.",
        "gstElement": "opusenc",
        "params": {
            "frame-size": {
        ...
        "gstSetup": {"inband-fec": True, "packet-loss-percentage": 5, "dtx": True},
        "sidechain": True,
    ...
    "opusrtcsrc": {
        "type": "opusrtcsrc",
        "displayType": "Opus RTP Recv",
        "help": "Get Opus audio from an RTP stream",
        "gstElement": "opusdec",
        "params": {
            "preSupport.1.address": {
                "displayName": "Address",
                "type": "string",
                "value": "224.0.1.116",
                "sort": 0,
        ...
        "gstSetup": {"plc": True, "use-inband-fec": True},
        "sidechain": False,
        "silenceMainChain": False,
        "preSupportElements": [
