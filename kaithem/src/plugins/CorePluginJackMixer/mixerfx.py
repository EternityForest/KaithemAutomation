...
effectTemplates_data = {
    ...
    "ladspa-tap-rotspeak-so-tap-rotspeak": {
        "type": "ladspa-tap-rotspeak-so-tap-rotspeak",
        "gstElement": "ladspa-tap-rotspeak-so-tap-rotspeak",
        "help": "TAP Rotary Speaker",
        "displayType": "TAP Rotary Speaker",
        "params": {
            "horn-frequency": {
                "type": "float",
                "min": 0,
                "max": 30,
                "displayName": "Horn Frequency",
                "value": 5,
                "step": 0.25,
            },
            "rotor-frequency": {
