...
eventsByModuleName: weakref.WeakValueDictionary[str, BaseEvent] = (
...
class BaseEvent:
    ...
    def __init__(
        ...
        self.pymodule = types.ModuleType(f"Event_{self.module}_{self.resource}")
        self.pymodule.__file__ = f"Event_{self.module}_{self.resource}"
    ...
    def handle_exception(
        self, e: Exception | None = None, tb: str | None = None
    ) -> None:
        global _lastGC
        if tb is None:
