...
def init_devices():
    ...
    try:
        ...
        messagebus.postMessage("/system/notifications/errors","Error with device drivers:\n"+traceback.format_exc(chain=True))
    ...
    for i in device_data:
        try:
            ...
            messagebus.postMessage("/system/notifications/errors","Error creating device: "+i)
